...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label21->Location = System::Drawing::Point(413, 390);
			...
			this->label22->Location = System::Drawing::Point(469, 390);
			...
			this->textBox1->Location = System::Drawing::Point(224, 379);
			...
			this->label27->Location = System::Drawing::Point(439, 419);
             ...
             if(round == 0)
			 {
				 if(x[1] < p[1])
				 {
                      if(stake > 0)
					  {
						  ...
						  myHand->set_player_money(myHand->get_player_money() - myHand->get_player_stake());
						  myHand->set_computer_stake(myHand->get_player_stake());
						  myHand->set_computer_money(myHand->get_computer_money() - myHand->get_computer_stake());
...
private: System::Void button3_Click(System::Object^  sender, System::EventArgs^  e) 
		 {
			 ...
			 if(round == 0)
			 {
                 if(x[1] > p[1])
				 {
					 myHand->set_player_stake(myHand->get_computer_stake());
					 myHand->set_player_money(myHand->get_player_money() - myHand->get_player_stake());
					 this->label23->Text = myHand->get_computer_money().ToString();
			         this->label24->Text = myHand->get_computer_stake().ToString();
					 this->label25->Text = myHand->get_player_money().ToString();
